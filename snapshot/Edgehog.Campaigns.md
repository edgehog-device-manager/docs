# `Edgehog.Campaigns`
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.13.0-rc.1/backend/lib/edgehog/campaigns/campaigns.ex#L21)
...
Runs authorization checks for `Edgehog.Campaigns.Campaign.mark_as_scheduled`
...
# `changeset_to_mark_campaign_scheduled`
...
Calls the mark_as_scheduled action on Edgehog.Campaigns.Campaign.
