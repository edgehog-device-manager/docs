...
Runs authorization checks for `Edgehog.Files.FileDownloadRequest.set_deleted`
...
# `changeset_to_set_file_download_deleted_attribute`
...
# `set_file_download_deleted_attribute`

Calls the set_deleted action on Edgehog.Files.FileDownloadRequest.
