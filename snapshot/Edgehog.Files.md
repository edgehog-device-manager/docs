...
Runs authorization checks for `Edgehog.Files.DeviceFile.create`
...
Runs authorization checks for `Edgehog.Files.FileDeleteRequest.read`
...
Runs authorization checks for `Edgehog.Files.DeviceFile.set_deleted`
...
Runs authorization checks for `Edgehog.Files.FileDeleteRequest.send_file_delete_request`
...
Runs authorization checks for `Edgehog.Files.DeviceFile.set_path_on_device`
...
Runs authorization checks for `Edgehog.Files.DeviceFile.set_size_bytes`
...
Runs authorization checks for `Edgehog.Files.FileDeleteRequest.set_response`
...
Runs authorization checks for `Edgehog.Files.FileDeleteRequest.set_status`
...
# `changeset_to_set_device_file_path_on_device`
...
# `changeset_to_set_device_file_size_bytes`
...
# `changeset_to_set_file_deletion_status`
...
Calls the create action on Edgehog.Files.DeviceFile.
...
Calls the read action on Edgehog.Files.DeviceFile.
...
# `fetch_file_delete_request`

Calls the read action on Edgehog.Files.FileDeleteRequest.
...
# `input_to_send_file_delete_request`
...
# `mark_device_file_as_deleted`

Calls the set_deleted action on Edgehog.Files.DeviceFile.
...
# `query_to_fetch_device_file_by_file_id`
...
# `query_to_fetch_file_delete_request`
...
# `send_file_delete_request`

Calls the send_file_delete_request action on Edgehog.Files.FileDeleteRequest.
...
# `set_device_file_path_on_device`

Calls the set_path_on_device action on Edgehog.Files.DeviceFile.
...
# `set_device_file_size_bytes`

Calls the set_size_bytes action on Edgehog.Files.DeviceFile.
...
# `set_file_delete_response`

Calls the set_response action on Edgehog.Files.FileDeleteRequest.

# Inputs

* status
* response_code - Success or error code for the transfer. A 0 code is a success, errors are POSIX errno.
* response_messages - Optional messages for the response
...
# `set_file_deletion_status`

Calls the set_status action on Edgehog.Files.FileDeleteRequest.
