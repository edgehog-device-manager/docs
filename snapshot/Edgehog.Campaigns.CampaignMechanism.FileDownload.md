...
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.12.0/backend/lib/edgehog/campaigns/campaign_mechanism/file_download/file_download.ex#L21)
...
```elixir
@type t() :: %Edgehog.Campaigns.CampaignMechanism.FileDownload{
