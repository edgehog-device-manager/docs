# `Edgehog.Devices`
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.13.1/backend/lib/edgehog/devices/devices.ex#L19)
...
Runs authorization checks for `Edgehog.Devices.SystemModel.destroy`
...
Runs authorization checks for `Edgehog.Devices.Device.read`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_container_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_deployment_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_device_mapping_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_device_request_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_image`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_network_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_create_volume_request`
...
Runs authorization checks for `Edgehog.Devices.Device.send_release_command`
...
Runs authorization checks for `Edgehog.Devices.Device.update_application`
...
# `changeset_to_send_create_container_request`
...
# `changeset_to_send_create_deployment_request`
...
# `changeset_to_send_create_device_mapping_request`
...
# `changeset_to_send_create_device_request_request`
...
# `changeset_to_send_create_image_request`
...
# `changeset_to_send_create_network_request`
...
# `changeset_to_send_create_volume_request`
...
# `changeset_to_send_release_command`
...
# `changeset_to_update_application`
...
Calls the read action on Edgehog.Devices.Device.
...
# `query_to_fetch_device_by_identity`
...
# `send_create_container_request`

Sends a create container request to the device.

# Arguments

* container - The Container the device has to initiate.
* deployment - The deployment in which this container is used
...
Send a create deployment request to the device.

# Arguments

* deployment - The Deployment the device has to instantiate.
...
# `send_create_device_mapping_request`

Send a create device-file mapping request to the device.

# Arguments

* device_mapping - The new device-file mapping for the device.
* deployment - The deployment in which this device-file mapping is used.
...
# `send_create_device_request_request`

Send a create device request to the device.

# Arguments

* device_request - The new device request for the device.
* deployment - The deployment in which this device request is used.
...
Sends a create image request to the device.

# Arguments

* image - The image the device will pull.
* deployment - The deployment in which this image is used
...
# `send_create_network_request`

Sends a create network request to the device.

# Arguments

* network - The Network the device has to create.
* deployment - The deployment in which this network is used
...
# `send_create_volume_request`

Send a create volume request to the device.

# Arguments

* volume - The new volume for the device.
* deployment - The deployment in which this volume is used
...
Sends a command for the given application release.

# Arguments

* release - The release target of the command.
* command
...
Updates an application to a newer release.

# Arguments

* from - The release to be upgraded. Should be currently installed.
This argument is needed because there might be multiple versions of a single application installed on the device.

* to - The new release of the application
