# `Edgehog.Campaigns.CampaignMechanism.DeploymentUpgrade`
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.13.0-rc.1/backend/lib/edgehog/campaigns/campaign_mechanism/deployment_upgrade/deployment_upgrade.ex#L21)
...
```elixir
@type t() :: %Edgehog.Campaigns.CampaignMechanism.DeploymentUpgrade{
