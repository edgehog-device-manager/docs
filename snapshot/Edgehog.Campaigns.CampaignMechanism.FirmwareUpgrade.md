...
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.13.1/backend/lib/edgehog/campaigns/campaign_mechanism/firmware_upgrade/firmware_upgrade.ex#L21)
