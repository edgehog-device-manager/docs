...
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.12.0/backend/lib/edgehog/campaigns/campaign_mechanism/deployment_delete/deployment_delete.ex#L21)
...
```elixir
@type t() :: %Edgehog.Campaigns.CampaignMechanism.DeploymentDelete{
