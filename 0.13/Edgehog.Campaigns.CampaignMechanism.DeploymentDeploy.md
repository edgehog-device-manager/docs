...
[🔗](https://github.com/edgehog-device-manager/edgehog/blob/v0.13.1/backend/lib/edgehog/campaigns/campaign_mechanism/deployment_deploy/deployment_deploy.ex#L21)
